...
<li><a href="Dashboard.jsp">Dashboard</a></li>
						    	...
						    	<li class="active"><a href="favorite.jsp">Favorites</a></li>
                        ...
                        <div class="col-md-3">
                            <div class="grid1">
                                <div class="view view-first">
                                     <a href="SongProfile.jsp?id=<%out.println(song_id[j]);%>">
                                ...
                                <div class="inner_wrap" style="height:220px;">
                                    ...
                                    <h3 class="deletefavorite_button"><a href="deletefavorite.jsp?songid=<%out.println(song_id[j]);%>">delete</a></h3>
                                    <ul class="star1">
                        ...
                        <div class="col-md-3">
                            <div class="grid1">
                                ...
                                <div class="inner_wrap" style="height:220px;">
                                    ...
                                    <h3 class="deletefavorite_button"><a href="deletefavorite.jsp?songid=<%out.println(song_id[j]);%>">delete</a></h3>
                                    <ul class="star1">
                                        <h4 class="green1" style="font-size: 18px"><% out.println(artist_name[j]); %></h4>
                        ...
                        <div class="col-md-3">
                            <div class="grid1">
                                ...
                                <div class="inner_wrap" style="height:220px;">
                                    ...
                                    <h3 class="deletefavorite_button"><a href="deletefavorite.jsp?songid=<%out.println(song_id[j]);%>">delete</a></h3>
                                    <ul class="star1">
                                        <h4 class="blue1" style="font-size: 18px"><% out.println(artist_name[j]); %></h4>
